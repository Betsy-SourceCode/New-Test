...
namespace Customer.Models.SqlMethods
{
    ...
    public class GetDefault
    {
        ...
        /// <returns></returns>
        public List<NEWSelectIndex> GetDefaultSql(string ShortName, string Name_CN, string K3Code, int pageIndex, int pageSize, string Rank)
        {
            ...
            {
                newlist.Add(new NEWSelectIndex { list= item, dep=Info})
            }
