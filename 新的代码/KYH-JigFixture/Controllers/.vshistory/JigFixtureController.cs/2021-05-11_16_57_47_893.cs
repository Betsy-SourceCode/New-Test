     ...
     /// <returns></returns>
        ...
        public string SelectK3PO_Num(string K3PO_Num)
        {
            ...
            try
            {
                ...
                if (num == "HS")
                {
                    var list = getIndex.ByK3PO_NumSelect("HS_YHNPN", K3PO_Num);
                    object obj = new
                    {
                        Data = list
                    };
                    Others json1 = new Others() { Data = obj };
                }
                else if (num == "YH")
                {
                    var list = getIndex.ByK3PO_NumSelect("AIS20070103075708", K3PO_Num);
                    object obj = new
                    {
                        Data = list
                    };
                    Others json2 = new Others() { Data = obj };
                }
                else
                {
