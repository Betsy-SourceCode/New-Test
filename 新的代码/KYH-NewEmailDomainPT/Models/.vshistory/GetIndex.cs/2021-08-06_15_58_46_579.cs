...
namespace KYH_NewEmailDomainPT.Models
{
    public class GetIndex
    {
        ...
        {
            string sql = @"select DNSerial,DomainName,FindDate,(CASE SourceType WHEN 1 THEN ' Normal 正常' WHEN 2 THEN 'Market 市场推销' WHEN 3 THEN 'Phish 钓鱼电邮' WHEN 4 THEN  'Phish 钓鱼电邮' WHEN 5 THEN 'Virus 病毒木马'  END) as SourceType,Remarks from [dbo].[NewEmailDomain2GIP]
